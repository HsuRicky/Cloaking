...
(function(s){"use strict";var o=function(){setTimeout(function(){s("#spinner").length>0&&s("#spinner").removeClass("show")},1)};o(),(new WOW).init(),s(window).scroll(function(){s(this).scrollTop()>300?s(".sticky-top").addClass("shadow-sm").css("top","0px"):s(".sticky-top").removeClass("shadow-sm").css("top","-100px")})})(jQuery);